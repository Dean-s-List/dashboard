                ...
                <span className="w-[50%] items-center justify-center">
                  ...
                  <div
                    className={`badge badge-md mx-auto ml-4 ${
                      data && data.category == CategoryEnum.UXUI
                        ? `uxui`
                        : data && data.category == CategoryEnum.Docs
                        ? `docs`
                        : data && data.category == CategoryEnum.Strategy
                        ? `strategy`
                        : data && data.category == CategoryEnum.Community
                        ? `community`
                        : `error`
                    }`}
                  >
