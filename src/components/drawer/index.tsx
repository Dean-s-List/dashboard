...
const SideBar: FC = () => (
  <div className="static top-0 hidden max-h-[100vh] min-h-[100vh] w-[14vw] self-start border bg-primary-dark md:block">
    ...
    <div className="relative bottom-0 left-0 w-[100%] max-w-[23vh]">
      <ul className="bg-normal menu menu bottom-0 w-full">
